...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://arturzia.github.io/";
   ...
   private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("ArturZia");
        driverTrello.findElement(By.id("password")).sendKeys("Lipiec2018");
